      ...
      <div class="center2">
         ...
         <div class="center2height">
            ...
            <div class="center2height_child_1">
				<div class="center2height_child_2_side">
				
				</div>
	            <div class="center2height_child_2">
		            	<a class="boardLink" href="USER_userCVList.do" >이력서 : </a>
		            	<a class="board_NumberLink" href="USER_userCVList.do" >2</a>
	            </div>
	            <div class="center2height_child_2_between">
	            
	            </div>
	            <div class="center2height_child_2">
	            	<a class="boardLink" href="USER_userPFList.do">포트폴리오 : </a>
	            	<a class="board_NumberLink" href="USER_userPFList.do">8</a>
	            </div>
	            <div class="center2height_child_2_between">
	            
	            </div>
	            <div class="center2height_child_2">
	            	<a class="boardLink" href="USER_userJobList.do">채용 즐겨찾기 : </a>
	            	<a class="board_NumberLink" href="USER_userJobList.do">9</a>
	            </div>
	            <div class="center2height_child_2_side">
