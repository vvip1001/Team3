	...
	<div class="container">
		...
		<div class="center" id="center">
			<f:form name="PFform" action="PFinsert.do" method="post"
				...
				<div id="pdfwrap">
					<div id="PFinfo">
						...
						<table class="PFtable">
							<tr>
								<th>프로젝트명</th>
								<td class="PFinfo"><f:input class="form-control"
										type="text" path="targets[0].title" /></td>
							</tr>

							<tr>
								<th>수행기간</th>
								<td class="PFinfo"><f:input class="form-control"
										type="text" path="targets[0].question" /></td>
							</tr>
							<tr>
								<th>개발목표</th>
								<td class="PFinfo"><f:textarea class="form-control"
										rows="7" cols="60" path="targets[0].subtitle" /></td>
							</tr>
							<tr>
								<th>개발환경</th>
								<td class="PFinfo"><f:textarea class="form-control"
										rows="7" cols="60" path="targets[0].content" /></td>
							</tr>
							<tr>
								<th>구현기능</th>
								<td class="PFinfo"><f:textarea class="form-control"
										rows="7" cols="60" path="targets[0].functions" /></td>
							</tr>
							<tr>
								<th>담당역할</th>
								<td class="PFinfo"><f:textarea class="form-control"
										rows="7" cols="60" path="targets[0].positions" /></td>
							</tr>
							<tr>
								<th>참여도 / 기여도</th>
								<td class="PFinfo"><f:input class="form-control"
										type="text" path="targets[0].participation" /></td>
							</tr>
						</table>
					...
					<div id="PFdetail">
						<div id="PFbtn">
							<button id="minus" onclick="minus(this);" class="btn"
								type="button">
								<!-- <img alt="minus" src="resources/IMG/minus.png" style="width: 20px; height: 20px;"> -->
								삭제 <img alt="minus" onclick="minus(this);"
									src="resources/IMG/minusbutton.png"
						...
						<div id="PFcenter" style="display: flex;">
							...
							<div id="main" style="flex: 2; display: flex;">
								...
								<fieldset id="function" style="flex: 2;">
									...
									<f:textarea id="functioninfo" path="targets[0].functioninfo" />
								</fieldset>
							</div>
							<div class="margin" style="flex: 0.1;"></div>
						</div>
						...
						<div id="PFlast">
							<fieldset id="viewinfo">
								...
								<f:textarea id="viewinfo1" path="targets[0].viewinfo" />
							</fieldset>
						</div>
					</div>
					<div id="filed"></div>
				...
				<div class="btn-grp">
					<input type="submit" id="create_pdf1" value="저장하기"> <input
						type="button" id="create_pdf2" value="PDF다운로드"
						onclick="pdfprint();" />
				</div>
			</f:form>
