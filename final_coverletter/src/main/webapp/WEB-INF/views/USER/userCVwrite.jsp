	...
	<form action="USER_userCVinsert.do" method="post">
		...
		<div class="container title-container">
			<div id="title-area">
				...
				<div class="input-group">
					<span class="input-group-addon">제&nbsp;&nbsp;목</span> <input
		...
		<div class="container cv-container">
			<div id="cv-area">
				<div id="input-grp">
					<div class="input-group">
						<span class="input-group-addon">소제목</span> <input type="text"
							class="form-control" name="subtitle" placeholder="소제목을 입력하세요.">
					</div>
					<div class="input-group">
					...
					<div class="count-area">
						<p class="count-text">
							공백 포함 <span class="count-span" id="cntArea-a">0</span>자 / 공백 미포함
							<span class="count-span" id="cntArea-b">0</span>자
						</p>
					</div>
					<!-- 글자수 영역 끝 -->
					...
					<div class="row" class="">
						<div class="col-md-2">
							<fieldset class="cv-box">
								...
								<textarea class="textarea" name="content"
									onkeydown="contentCnt(this);"></textarea>
							</fieldset>
						...
						<div class="col-md-2">
							...
							<button class="btn cv-btn" type="button"
								onclick="spellCheck(this);">맞춤법검사</button>
						</div>
					</div>
				</div>
				<!-- CLONE button 영역 -->
		...
		<div class="container submit-container">
			<div class="submit-area">
				...
				<button class="btn" onclick="location.href='JOB_jobCenter.do'"
