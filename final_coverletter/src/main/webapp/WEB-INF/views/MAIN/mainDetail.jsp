...
<body>
	...
	<div class="container" id="main">
		...
		<form action="" method="post">
			<div class="row" id="img">
				<div class="col-md-12">
					<div class="logo_img"><img class="img" src="${mainDetail.imgurl }"></div>
				</div>
	...
	<c:otherwise>
		...
		<div class="information" >
			...
			${companyDto.companyname}<br> 
			${companyDto.business }<br>
			${companyDto.target }<br> 
			${companyDto.languages }<br>
		...
		<form action="" method="post">
			...
			<div id="incorporation">
				...
				<div>
					...
					<div class="content"><a href="${mainDetail.homepage }">${mainDetail.homepage }</a></div> 
