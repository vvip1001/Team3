...
INSERT INTO JOINUSER(JOINSEQ,JOINEMAIL,JOINNAME,JOINPW,JOINBIRTH,JOINSEX,PHONE, SINGUP )
VALUES(JOIN_SEQ.NEXTVAL, 'abc@naver.com', 'name', 'abc', '19990101', 'F', '010-0000-0000', 'Y');
...
(
    ...
    JOINEMAIL         VARCHAR2(200)     NOT NULL, 
    CVCATEGORY        VARCHAR2(30)      NOT NULL, 
    QUESTION          VARCHAR2(1000)    NOT NULL, 
    TITLE             VARCHAR2(500)     NOT NULL, 
    SUBTITLE          VARCHAR2(500)     NOT NULL, 
