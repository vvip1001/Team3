...
import com.job.coverletter.Elastic.ElasticApi;
...
public class JobController {
	...
	private ElasticSpringExampleApplication elastic = new ElasticSpringExampleApplication();
	...
	public @ResponseBody String jobSearchRes(@ModelAttribute CompanyDto jsonKey) {
		...
		//CompanyDto keyDto = new CompanyDto();
		String res = elastic.jabSearchRes(jsonKey);
